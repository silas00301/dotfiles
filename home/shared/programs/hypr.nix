  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mod CTRL, 1, workspace, 9"
        "$mod CTRL, 2, workspace, 10"
        "$mod CTRL, 3, workspace, 11"
        "$mod CTRL, 4, workspace, 12"
        ...
        "$mod CTRL SHIFT, 1, movetoworkspace, 9"
        "$mod CTRL SHIFT, 2, movetoworkspace, 10"
        "$mod CTRL SHIFT, 3, movetoworkspace, 11"
        "$mod CTRL SHIFT, 4, movetoworkspace, 12"
